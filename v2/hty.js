$(document).ready(function() {
  'use strict';
   ...
   var trainNumbers; // shows the train numbers such as 965, 1002
    ...
    // train numbers are fetched here (such as 963,995,etc.)
         ...
         $.getJSON( URL, function( data ) {
            ...
            for(var i = 0; i < len ; i++)
            {
             ...
             var str = '<div class="col-lg-4 col-md-6  col-sm-12">	<div class="thumbnail">'+
                             '<p class="split-para">' + trainType +" "+ trainNumber + '<span><span style="color:red;">'+ dep+'</span><span style="color:green;">' +end+'</span>'+'<br> <hr></span></p>'+
